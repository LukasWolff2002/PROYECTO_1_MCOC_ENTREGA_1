...
def laplace (caso, nombre, grilla, factor_correccion, factor):
    ...
    if C2 != ly:
        ...
        potential[0, nx//2:] = Potencial_incial     # Borde superior: potencial alto
        potential[0, :ny//2] = Potencial_final   # Borde superior: potencial alto
...
laplace(caso_ejemplo, 'caso_ejemplo_final', 60, False, 0) #No debo poner un j, convergencia alcanzada